...
!   uses: gyre_diff_factory gyre_context gyre_rad_eqns gyre_ext ISO_FORTRAN_ENV gyre_mode_par gyre_osc_par gyre_rad_match gyre_point gyre_state gyre_num_par core_kinds
