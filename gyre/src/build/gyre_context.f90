...
!   uses: gyre_grid_par gyre_model gyre_interp core_kinds gyre_osc_par core_order gyre_grid ISO_FORTRAN_ENV gyre_point gyre_rot gyre_mode_par gyre_rot_factory gyre_state gyre_freq
