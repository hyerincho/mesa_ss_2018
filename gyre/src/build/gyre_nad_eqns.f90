...
!   uses: core_kinds gyre_linalg gyre_model gyre_osc_par ISO_FORTRAN_ENV gyre_eqns gyre_model_util gyre_mode_par gyre_point gyre_nad_trans gyre_state gyre_context
