...
!   uses: gyre_ad_bvp gyre_constants gyre_freq gyre_rad_bvp gyre_ext ISO_FORTRAN_ENV gyre_context core_memory core_parallel gyre_mode_par gyre_model gyre_grid gyre_num_par gyre_scan_par gyre_rot gyre_state gyre_mode core_order gyre_bvp gyre_root gyre_osc_par gyre_wave core_kinds gyre_rot_factory gyre_discrim_func gyre_status gyre_util gyre_point
