...
!   uses: ISO_FORTRAN_ENV gyre_model gyre_grid gyre_point gyre_ad_trans gyre_ad_bound gyre_mode_par gyre_ad_eqns core_kinds gyre_grid_factory gyre_bvp gyre_context gyre_osc_par gyre_ext gyre_qad_eval gyre_num_par gyre_interp gyre_ad_diff gyre_wave gyre_state
