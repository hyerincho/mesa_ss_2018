...
!   uses: core_kinds gyre_ext gyre_grid gyre_grid_util core_parallel gyre_wave gyre_state ISO_FORTRAN_ENV gyre_mode_par gyre_util gyre_context gyre_osc_par
!   provides: gyre_mode
!end dependencies
!
!end fpx3_header
