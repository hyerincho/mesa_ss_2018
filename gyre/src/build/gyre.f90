...
!   uses: gyre_scan_par gyre_output gyre_mode gyre_osc_par gyre_grid_factory gyre_version gyre_util ISO_FORTRAN_ENV gyre_model gyre_mode_par gyre_bvp gyre_rad_bvp gyre_search gyre_constants gyre_out_par core_parallel gyre_grid_par gyre_grid gyre_num_par gyre_ext gyre_nad_bvp core_kinds gyre_model_factory gyre_model_par core_system gyre_context gyre_ad_bvp
!   provides: 
!end dependencies
!
!end fpx3_header
