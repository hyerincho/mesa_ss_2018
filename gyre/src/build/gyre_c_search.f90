...
!   uses: gyre_status core_kinds core_parallel gyre_wave gyre_state ISO_FORTRAN_ENV gyre_discrim_func gyre_bvp core_order gyre_mode gyre_ext gyre_root gyre_osc_par gyre_constants gyre_util gyre_num_par gyre_mode_par gyre_nad_bvp
