...
!   uses: gyre_nad_eqns gyre_trapz_diff gyre_magnus_diff gyre_mode_par gyre_state gyre_colloc_diff gyre_num_par gyre_point gyre_osc_par gyre_diff core_kinds ISO_FORTRAN_ENV gyre_ext gyre_context gyre_diff_factory gyre_nad_match
