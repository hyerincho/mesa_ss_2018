...
!   sources: -
!   includes: ../extern/core/core.inc ../interp/gyre_interp.inc ../extern/core/core_parallel.inc
!   uses: core_parallel core_linalg ISO_FORTRAN_ENV gyre_calc core_kinds core_order core_hgroup
