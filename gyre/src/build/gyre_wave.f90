...
!   uses: gyre_ext gyre_rot gyre_grid_util gyre_model core_kinds core_parallel gyre_constants gyre_util gyre_state gyre_grid ISO_FORTRAN_ENV gyre_osc_par gyre_freq gyre_context gyre_mode_par gyre_evol_model gyre_point
!   provides: gyre_wave
!end dependencies
!
!end fpx3_header
