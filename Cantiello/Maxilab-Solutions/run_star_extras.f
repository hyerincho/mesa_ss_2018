...
! ***********************************************************************
      ...
      subroutine energy_routine(id, ierr)
        ...
        ! R_engulf is the coordinate of the planet's closest point to the stellar center.
        ! If this is the beginning of an engulfment run, R_engulf is set to be the radius of the star in 'extras_startup', so to initialize a grazing collision.
        ! If it's a restart, MESA will remember the radial location of the engulfed planet R_planet from a photo. This is because we are moving R_engulf data in
        ...
        ! Not much happening here...
          ...
          if ( f_disruption <= 1d0 ) then
              ...
              ! If the planet has not been destroyed by ram pressure, deposit drag luminosity and heat the envelope
              ! Spread in the region occupied by the planet. Update radial coordinate of the engulfed planet in 'extras_finish_step' using Deltar.
        ...
        ! Save variables for history
         ...
         s% xtra1 = v_kepler/1d5                ! Orbital velocity (km/s)
         s% xtra2 = Deltar                      ! Infall distance  (cm)
         s% xtra3 = de                          ! Injected energy  (ergs)
         s% xtra4 = f_disruption                ! Disruption factor
         s% xtra5 = area/(pi * pow2(r_planet))  ! Engulfed fraction
         s% xtra6 = dmsum/Msun                  ! Heated mass      (Msun)
         s% xtra7 = rho_bar                     ! Mean density at planet location (g/cm^3)
